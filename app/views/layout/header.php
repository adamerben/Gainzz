        ...
        <div class="container mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center">
            ...
            <nav>
                <ul class="flex items-center space-x-6">
                    <li>
                        <a href="<?= BASE_URL ?>/index.php" class="text-slate-300 hover:text-orange-400 transition-colors font-bold uppercase tracking-wider text-sm">Katalog cviků</a>
                    </li>
                    ...
                    <?php else: ?>
                        <li>
                            <a href="<?= BASE_URL ?>/index.php?url=auth/login" class="text-slate-300 hover:text-orange-400 transition-colors font-bold uppercase tracking-wider text-sm">Přihlásit</a>
                        </li>
                        <li>
                            <a href="<?= BASE_URL ?>/index.php?url=auth/register" class="bg-slate-700 hover:bg-slate-600 text-white font-bold px-5 py-2 rounded-md transition-all">
                                Registrace
                            </a>
                        </li>
                    <?php endif; ?>
