...
<main class="container mx-auto px-6 py-10 flex-grow">
    <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100">
            ...
            <div class="lg:w-1/2 p-10 flex flex-col">
                ...
                <?php if (!empty($exercise['video_link'])): ?>
                    <div class="mt-4 mb-8 pt-8 border-t border-slate-100">
                        ...
                        <?php else: ?>
                            <a href="<?= htmlspecialchars($exercise['video_link']) ?>" target="_blank" class="inline-flex items-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold px-6 py-3 rounded-xl transition-colors">
                ...
                <div class="mt-auto pt-8 border-t border-slate-100 flex gap-4 items-center">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="<?= BASE_URL ?>/index.php?url=auth/login" class="bg-orange-500 text-white font-black uppercase px-8 py-4 rounded-xl hover:bg-orange-600 transition-all shadow-lg flex-grow text-center tracking-widest">
        ...
        <div class="bg-slate-50 p-6 md:p-10 border-t-4 border-slate-100">
            <h3 class="text-2xl font-black text-slate-900 uppercase italic tracking-tight mb-8">Diskuze k <span class="text-orange-500">cviku</span></h3>
            ...
            <?php else: ?>
                <div class="mb-10 bg-orange-100 border-l-4 border-orange-500 p-4 rounded-r-xl">
                    <p class="text-orange-800 font-bold text-sm">Pro přidání komentáře se musíte <a href="<?= BASE_URL ?>/index.php?url=auth/login" class="underline hover:text-orange-900">přihlásit</a>.</p>
                </div>
            <?php endif; ?>
