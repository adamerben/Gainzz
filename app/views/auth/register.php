...
<main class="container mx-auto px-6 py-12 flex-grow flex items-center justify-center">
    <div class="w-full max-w-lg">
        <div class="mb-8 text-center">
            <h2 class="text-4xl font-black tracking-widest text-slate-900 uppercase italic">Nová <span class="text-orange-500">registrace</span></h2>
        ...
        <div class="bg-white border border-slate-100 rounded-3xl shadow-xl p-8 md:p-10">
            <form action="<?= BASE_URL ?>/index.php?url=auth/storeUser" method="post" class="space-y-6">
                ...
                <div>
                    <label for="username" class="block text-xs font-black text-slate-500 mb-2 uppercase tracking-widest">Uživatelské jméno <span class="text-orange-500">*</span></label>
                ...
                <div>
                    <label for="email" class="block text-xs font-black text-slate-500 mb-2 uppercase tracking-widest">E-mail <span class="text-orange-500">*</span></label>
                    <input type="email" id="email" name="email" required 
                           class="w-full bg-slate-50 border-2 border-slate-200 rounded-xl px-4 py-3 text-slate-800 font-bold focus:outline-none focus:border-orange-500 transition-colors">
                </div>

                <div>
                    <label for="password" class="block text-xs font-black text-slate-500 mb-2 uppercase tracking-widest">Heslo <span class="text-orange-500">*</span></label>
                ...
                <div class="mt-8 pt-4">
                    ...
                    <p class="text-center text-slate-500 text-sm mt-6 font-medium">
                        Už máte účet? <a href="<?= BASE_URL ?>/index.php?url=auth/login" class="text-orange-500 font-bold hover:text-orange-600 transition-colors underline decoration-orange-500/30 underline-offset-4">Přihlaste se zde</a>.
                    </p>
                </div>
            </form>
        </div>
