...
<main class="container mx-auto px-6 py-12 flex-grow flex items-center justify-center">
    <div class="w-full max-w-lg">
        <div class="mb-8 text-center">
            <h2 class="text-4xl font-black tracking-widest text-slate-900 uppercase italic">Vítejte <span class="text-orange-500">zpět</span></h2>
        ...
        <div class="bg-white border border-slate-100 rounded-3xl shadow-xl p-8 md:p-10">
            <form action="<?= BASE_URL ?>/index.php?url=auth/authenticate" method="post" class="space-y-6">
                ...
                <div>
                    <label for="email" class="block text-xs font-black text-slate-500 mb-2 uppercase tracking-widest">E-mail</label>
                ...
                <div>
                    <label for="password" class="block text-xs font-black text-slate-500 mb-2 uppercase tracking-widest">Heslo</label>
                ...
                <div class="mt-8 pt-4">
                    ...
                    <p class="text-center text-slate-500 text-sm mt-6 font-medium">
                        Nemáte ještě účet? <a href="<?= BASE_URL ?>/index.php?url=auth/register" class="text-orange-500 font-bold hover:text-orange-600 transition-colors underline decoration-orange-500/30 underline-offset-4">Zaregistrujte se</a>.
                    </p>
                </div>
            </form>
        </div>
